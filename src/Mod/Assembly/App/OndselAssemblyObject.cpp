...
FC_LOG_LEVEL_INIT("OndselAssembly", true, true, true)
...
int OndselAssemblyObject::generateSimulation(App::DocumentObject* sim)
{
    mbdAssembly = makeMbdAssembly();
    objectPartMap.clear();
...
OndselAssemblyObject::getMotionsFromSimulation(App::DocumentObject* sim)
{
    if (!sim) {
        return {};
    }
...
int Assembly::OndselAssemblyObject::updateForFrame(size_t index, bool updateJCS)
{
    if (!mbdAssembly) {
        return -1;
    }
...
size_t Assembly::OndselAssemblyObject::numberOfFrames()
{
    return mbdAssembly->numberOfFrames();
}

void OndselAssemblyObject::preDrag(std::vector<App::DocumentObject*> dragParts)
{
    bundleFixed = true;
    solve();
    bundleFixed = false;
...
void OndselAssemblyObject::doDragStep()
{
    try {
...
Base::Placement OndselAssemblyObject::getMbdPlacement(std::shared_ptr<ASMTPart> mbdPart)
{
    if (!mbdPart) {
...
bool OndselAssemblyObject::validateNewPlacements()
{
...
void OndselAssemblyObject::postDrag()
{
    mbdAssembly->runPostDrag();  // Do this after last drag
}

void OndselAssemblyObject::savePlacementsForUndo()
{
...
void OndselAssemblyObject::undoSolve()
{
...
void OndselAssemblyObject::clearUndo()
{
    previousPositions.clear();
}

void OndselAssemblyObject::exportAsASMT(std::string fileName)
{
    mbdAssembly = makeMbdAssembly();
    objectPartMap.clear();
    fixGroundedParts();
...
void OndselAssemblyObject::setNewPlacements()
{
    for (auto& pair : objectPartMap) {
        App::DocumentObject* obj = pair.first;
...
void OndselAssemblyObject::redrawJointPlacements(std::vector<App::DocumentObject*> joints)
{
...
void OndselAssemblyObject::redrawJointPlacement(App::DocumentObject* joint)
{
    if (!joint) {
        return;
    }
...
void OndselAssemblyObject::recomputeJointPlacements(std::vector<App::DocumentObject*> joints)
{
...
std::shared_ptr<ASMTAssembly> OndselAssemblyObject::makeMbdAssembly()
{
...
App::DocumentObject*
OndselAssemblyObject::getJointOfPartConnectingToGround(App::DocumentObject* part, std::string& name)
{
    if (!part) {
        return nullptr;
    }
...
template<typename T>
T* OndselAssemblyObject::getGroup()
{
...
JointGroup* OndselAssemblyObject::getJointGroup() const
{
    return Assembly::getJointGroup(this);
}

ViewGroup* OndselAssemblyObject::getExplodedViewGroup() const
{
    App::Document* doc = getDocument();
...
std::vector<App::DocumentObject*> OndselAssemblyObject::getGroundedJoints()
{
    std::vector<App::DocumentObject*> joints = {};
...
std::vector<App::DocumentObject*> OndselAssemblyObject::getJointsOfObj(App::DocumentObject* obj)
{
    if (!obj) {
        return {};
    }
...
std::vector<App::DocumentObject*> OndselAssemblyObject::getJointsOfPart(App::DocumentObject* part)
{
    if (!part) {
        return {};
    }
...
std::unordered_set<App::DocumentObject*> OndselAssemblyObject::getGroundedParts()
{
...
std::unordered_set<App::DocumentObject*> OndselAssemblyObject::fixGroundedParts()
{
    auto groundedParts = getGroundedParts();
...
void OndselAssemblyObject::fixGroundedPart(App::DocumentObject* obj,
                                           Base::Placement& plc,
                                           std::string& name)
{
    if (!obj) {
...
bool OndselAssemblyObject::isJointConnectingPartToGround(App::DocumentObject* joint,
                                                         const char* propname)
{
...
bool OndselAssemblyObject::isJointTypeConnecting(App::DocumentObject* joint)
{
    if (!joint) {
        return false;
    }
...
bool OndselAssemblyObject::isObjInSetOfObjRefs(App::DocumentObject* obj,
                                               const std::vector<ObjRef>& set)
{
    if (!obj) {
        return false;
    }
...
void OndselAssemblyObject::removeUnconnectedJoints(
    std::vector<App::DocumentObject*>& joints,
...
void OndselAssemblyObject::traverseAndMarkConnectedParts(
...
std::vector<ObjRef>
OndselAssemblyObject::getConnectedParts(App::DocumentObject* part,
                                        const std::vector<App::DocumentObject*>& joints)
{
    if (!part) {
        return {};
...
bool OndselAssemblyObject::isPartGrounded(App::DocumentObject* obj)
{
    if (!obj) {
        return false;
    }
...
bool OndselAssemblyObject::isPartConnected(App::DocumentObject* obj)
{
    if (!obj) {
        return false;
    }
...
void OndselAssemblyObject::jointParts(std::vector<App::DocumentObject*> joints)
{
    for (auto* joint : joints) {
        if (!joint) {
            continue;
...
void Assembly::OndselAssemblyObject::create_mbdSimulationParameters(App::DocumentObject* sim)
{
...
std::shared_ptr<ASMTJoint> OndselAssemblyObject::makeMbdJointOfType(App::DocumentObject* joint,
                                                                    JointType type)
{
    switch (type) {
...
std::shared_ptr<ASMTJoint> OndselAssemblyObject::makeMbdJointDistance(App::DocumentObject* joint)
{
...
OndselAssemblyObject::makeMbdJoint(App::DocumentObject* joint)
{
    if (!joint) {
        return {};
    }
...
std::string OndselAssemblyObject::handleOneSideOfJoint(App::DocumentObject* joint,
...
void OndselAssemblyObject::getRackPinionMarkers(App::DocumentObject* joint,
...
int OndselAssemblyObject::slidingPartIndex(App::DocumentObject* joint)
{
    App::DocumentObject* part1 = getMovingPartFromRef(this, joint, "Reference1");
    App::DocumentObject* obj1 = getObjFromRef(joint, "Reference1");
...
OndselAssemblyObject::MbDPartData OndselAssemblyObject::getMbDData(App::DocumentObject* part)
{
...
std::shared_ptr<ASMTPart> OndselAssemblyObject::getMbDPart(App::DocumentObject* part)
{
    if (!part) {
        return nullptr;
    }
...
OndselAssemblyObject::makeMbdPart(std::string& name, Base::Placement plc, double mass)
{
...
std::shared_ptr<ASMTMarker> OndselAssemblyObject::makeMbdMarker(std::string& name,
                                                                Base::Placement& plc)
{
...
std::vector<ObjRef> OndselAssemblyObject::getDownstreamParts(App::DocumentObject* part,
                                                             App::DocumentObject* joint)
{
    if (!part) {
        return {};
...
std::vector<App::DocumentObject*> OndselAssemblyObject::getUpstreamParts(App::DocumentObject* part,
                                                                         int limit)
{
    if (!part) {
        return {};
...
App::DocumentObject* OndselAssemblyObject::getUpstreamMovingPart(App::DocumentObject* part,
                                                                 App::DocumentObject*& joint,
                                                                 std::string& name)
{
...
double OndselAssemblyObject::getObjMass(App::DocumentObject* obj)
{
    if (!obj) {
        return 0.0;
    }
...
void OndselAssemblyObject::setObjMasses(
    std::vector<std::pair<App::DocumentObject*, double>> objectMasses)
{
    objMasses = objectMasses;
}

std::vector<AssemblyLink*> OndselAssemblyObject::getSubAssemblies()
{
...
void OndselAssemblyObject::ensureIdentityPlacements()
{
