...
class AssemblyWorkbench(Workbench):
    ...
    def Initialize(self):
        ...
        import CommandCreateAssembly, CommandInsertLink, CommandInsertNewPart, CommandCreateJoint, CommandSolveAssembly, CommandCreateView, CommandCreateSimulation, CommandCreateBom
        import Preferences
